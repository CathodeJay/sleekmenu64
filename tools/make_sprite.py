...
Converting one PNG used to mean installing a MIPS cross-compiler, because the
only way to produce a .sprite was libdragon's own mksprite. That is a absurd
price for "bring your own box art", so this module writes the container
directly.
