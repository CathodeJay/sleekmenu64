...
rows, the cell size being the glyph size. Spleen is drawn at 5x8 to begin
with, so each pixel of it is meant to be there -- no shrinking of a larger
font, which leaves letters ragged.
