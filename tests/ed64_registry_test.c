...
/* Host-side checks for registry.dat handling, run against the real files the
   firmware wrote, which are checked into tests/fixtures/registry/. Anything this
...
#define SAMPLE_03 "tests/fixtures/registry/sample-03.dat"
#define SAMPLE_02 "tests/fixtures/registry/sample-02.dat"
#define SAMPLE_01 "tests/fixtures/registry/sample-01.dat"
