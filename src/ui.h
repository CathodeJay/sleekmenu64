...
/* Frames the selection must sit still before the card is touched. Cover art
   used to live in the ROM, where a read cost nothing; it comes off the card
   now, and opening a file in a 3,400-entry exFAT tree is slow enough that
   loading one per keypress made scrolling crawl. Holding a direction now
   costs nothing at all, and a cover appears a tenth of a second after you
   stop. */
