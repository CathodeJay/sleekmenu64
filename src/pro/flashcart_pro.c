...
/* The EverDrive-64 Pro behind the cartridge interface.
   ...
   Everything here was first done by probe/pro_probe.c on a real cartridge,
   step by step, and this file keeps to that order: the MCU is asked its id
   before anything is written, the FIFO is drained before the first command,
